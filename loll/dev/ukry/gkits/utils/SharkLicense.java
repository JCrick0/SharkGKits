...
public class SharkLicense {
	...
	public SharkLicense(String licenseKey, String validationServer, Plugin plugin) {
		this.licenseKey = licenseKey;
		this.plugin = plugin;
		this.validationServer = validationServer;
	}

	public SharkLicense setSecurityKey(String securityKey) {
		this.securityKey = securityKey;
		return this;
	}

	public SharkLicense setConsoleLog(LogType logType) {
		this.logType = logType;
		return this;
	}

	public SharkLicense debug() {
		debug = true;
		return this;
	}
	...
	public boolean register() {
		...
		if (vt == ValidationType.VALID) {
			Bukkit.getConsoleSender().sendMessage(CC.translate("&8[&bSharkHub&8] &aYour license is valid!"));
			return true;
		} else {
			Bukkit.getConsoleSender().sendMessage(CC.translate("&8[&bSharkHub&8] &cYour license is invalid!"));
			Bukkit.getConsoleSender().sendMessage(CC.translate("&8[&bSharkHub&8] &cBuy our plugin at: https://www.mc-market.org/resources/22976/"));
